                ...
                if (TemporaryNewFieldValues.TryGetDynamicallyAddedFieldValues(__instance.target, out var addedFieldValues))
                {
                    ...
                    try
                    {
                        ...
                        foreach (var addedFieldValueKey in _cachedKeys)
                        {
                            ...
                            else if (existingValueType == typeof(string))
                            ...
                            else if (existingValueType == typeof(Color))
                            ...
                            else if (existingValueType == typeof(Vector3))
                            ...
                            else if (existingValueType == typeof(Vector4))
                            ...
                            else if (existingValueType == typeof(Rect))
                            ...
                            else if (existingValueType == typeof(AnimationCurve))
                            ...
                            else if (existingValueType == typeof(Bounds))
                            ...
                            else if (existingValueType == typeof(Gradient))
                            ...
                            else if (existingValueType == typeof(Vector2Int))
                                addedFieldValues[addedFieldValueKey] = EditorGUILayout.Vector2IntField(addedFieldValueKey,
                                    (Vector2Int)addedFieldValues[addedFieldValueKey]);
                            else if (existingValueType == typeof(Vector3Int))
                                addedFieldValues[addedFieldValueKey] = EditorGUILayout.Vector3IntField(addedFieldValueKey,
                                    (Vector3Int)addedFieldValues[addedFieldValueKey]);
                            else if (existingValueType == typeof(RectInt))
                            ...
                            else if (existingValueType == typeof(BoundsInt))
                                addedFieldValues[addedFieldValueKey] = EditorGUILayout.BoundsIntField(addedFieldValueKey,
